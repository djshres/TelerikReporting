namespace Telerik.Reporting.Examples.CSharp
{
    ...
    partial class ProductCatalog
    {
        ...
        private void InitializeComponent()
        {
            ...
            // textBox1
            // 
            this.textBox1.Bindings.Add(new Telerik.Reporting.Binding("Style.Font.Name", "= If(Parameters.CultureID.Value = \'zh-cht\', \'Microsoft JhengHei\', If(Paramet" +
    ...
    "ields.ProductCategory) + \' of \' + PageCount(\'group1\', Fields.ProductCategory)";
            ...
            this.PageSettings.PaperKind = PaperKind.Letter;
