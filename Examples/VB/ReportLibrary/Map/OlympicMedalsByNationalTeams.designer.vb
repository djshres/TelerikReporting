Partial Class OlympicMedalsByNationalTeams
    ...
    "-Public-images-osm_logo.svg.png"
        ...
        'medalsData
        '
        Me.medalsData.CalculatedFields.AddRange(New Telerik.Reporting.CalculatedField() {New Telerik.Reporting.CalculatedField("Medal", GetType(String), "=If(Fields.Place = 1, 'Gold', " & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "If(Fields.Place = 2, 'Silver', " & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "If(Fields.Pla" &
                    "ce = 3, 'Bronze', 'none')))")})
