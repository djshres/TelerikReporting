Partial Class CryptoCurrencyRawData
    ...
    "ics.io/data-downloads/</a>"
        ...
        Me.CurrenciesList.Parameters.AddRange(New Telerik.Reporting.ObjectDataSourceParameter() {New Telerik.Reporting.ObjectDataSourceParameter("forDate", GetType(Date), "= AddDays(Today(), -2)")})
        '
        'CryptocurrencyRaw
        '
