...
#Region "Component Designer generated code"
    ...
    "=1.0.0.0, Culture=neutral, PublicKeyToken=null"
        ...
        Me.textBoxFact.Bindings.Add(New Telerik.Reporting.Binding("Action", "=If(Fields.ProductCategory IS NULL, NULL, ReportItem.ItemDefinition.Action)"))
        Me.textBoxFact.Bindings.Add(New Telerik.Reporting.Binding("ToolTip.Text", "=If(Fields.ProductCategory IS NULL, NULL, ReportItem.ItemDefinition.ToolTip.Text" &
            ")"))
        Me.textBoxFact.Bindings.Add(New Telerik.Reporting.Binding("ToolTip.Title", "=If(Fields.ProductCategory IS NULL, NULL, ReportItem.ItemDefinition.ToolTip.Titl" &
            "e)"))
