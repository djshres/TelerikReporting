...
Class Window1
        ...
        If themeNameParts.Length > 1 Then
            Select Case themeName
                Case "Windows11"
                    ...
                    Windows11Palette.LoadPreset(DirectCast(GetPresetEnum(GetType(Windows11Palette.ColorVariation), themeNameParts(1)), Windows11Palette.ColorVariation))
                    Exit Select
                Case "Office2019"
                ...
                Case "VisualStudio2019"
                    VisualStudio2019Palette.LoadPreset(DirectCast(GetPresetEnum(GetType(VisualStudio2019Palette.ColorVariation), themeNameParts(1)), VisualStudio2019Palette.ColorVariation))
                    Exit Select
                ...
                Case "Crystal"
                    ...
                    Exit Select
                Case "Material"
                    MaterialPalette.LoadPreset(DirectCast(GetPresetEnum(GetType(MaterialPalette.ColorVariation), themeNameParts(1)), MaterialPalette.ColorVariation))
                    Exit Select
            End Select
    ...
    Private Shared Function GetLayoutBackground(themeName As String, themeVariation As String, grid As Panel) As Color
        Select Case themeName
            Case "VisualStudio2013", "Green", "Fluent", "Crystal"
            ...
            Case "Windows11"
                If themeVariation = "Dark" Then
                    Return Color.FromArgb(&HFF, &H0, &H0, &H0)
                ElseIf themeVariation = "System" Then
            ...
            Case "Office2019"
                If themeVariation = "Dark" Then
                    Return Color.FromArgb(&HFF, &H15, &H15, &H15)
                ElseIf themeVariation = "HighContrast" Then
                    Return Color.FromArgb(&HFF, &H0, &H0, &H0)
                Else
                    Return Color.FromArgb(&HFF, &HFF, &HFF, &HFF)
                End If
            Case "VisualStudio2019"
                If themeVariation = "Dark" Then
                    Return Color.FromArgb(&HFF, &H27, &H28, &H28)
                Else
                    Return Color.FromArgb(&HFF, &HFF, &HFF, &HFF)
                End If
            Case "Material"
                If themeVariation = "Dark" Then
                    Return Color.FromArgb(&HFF, &H12, &H12, &H12)
                Else
                    Return Color.FromArgb(&HFF, &HFF, &HFF, &HFF)
                End If
            Case "Office2013"
