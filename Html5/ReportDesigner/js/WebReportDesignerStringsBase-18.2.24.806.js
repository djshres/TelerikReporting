 export class WebReportDesignerStringsBase  {
    constructor() { 
        ...
        this.ItemDataBound = "ItemDataBound";
        ...
        this.QueryBuilderButton = "Query Builder...";
        this.QueryBuilderStateWarningTitle = "SQL Query Designer State";
        this.QueryBuilderStateWarningMessage = "The SQL query was edited outside the SQL Query Designer or the DB schema was modified. Using the Query Designer will discard the SQL query changes.";
        this.QueryBuilderLoadingSchema = "Loading database metadata...";
        this.QueryBuilderWindowTitle = "Build select statement";
        this.QueryBuilderSelectedFields = "Selected fields";
        this.QueryBuilderRelationships = "Relationships";
        this.QueryBuilderFilters = "Filters";
        this.QueryBuilderResult = "Result";
        this.QueryBuilderSqlResult = "SQL";
        this.QueryBuilderDataResult = "Data";
        this.QueryBuilderSearchDataBaseObject = "Search table, view or column";
        this.QueryBuilderNoSelectedFields = "Start selecting fields from the tree on the left.";
        this.QueryBuilderTableNamePrompt = "Start typing table name...";
        this.QueryBuilderFieldNamePrompt = "Start typing field name...";
        this.QueryBuilderAddRelationshipWindowTitle = "Add relationship";
        this.QueryBuilderEditRelationshipWindowTitle = "Edit relationship";
        this.QueryBuilderEditRelationshipAddNewButton = "Add new relationship";
        this.QueryBuilderTablesSearchInSelectedTables = "Search in selected tables";
        this.QueryBuilderSortOrderValidationMessage = "Sort order should be an integer.";
        this.QueryBuilderGetDbSchemaErrorMessage = "Could not access the database schema.";
        this.QueryBuilderFilterValueOrParameterTitle = "Value or parameter";
        this.QueryBuilderFilterPreviewValueTitle = "Preview value";
        this.QueryBuilderPreviewButton = "Preview";
        this.QueryBuilderPreviewDirtyStateMessage = "The state has changed. Press 'Preview' again to generate results.";
        this.QueryBuilderPreviewNoSQL = "No SQL generated. Click 'Preview' button.";
        this.QueryBuilderPreviewNoData = "No data generated. Click 'Preview' button.";
        this.QueryBuilderPreviewEmptyDataSet = "No data retrieved.";
        this.QueryBuilderPreviewValidationError = "Validation error:";
        this.QueryBuilderLimitPreviewResults = "Preview shows only the first {previewMaxRows} results.";
        this.QueryBuilderFilterPreviewValueRequiredValidation = "Filter preview value for {fieldName} is required for preview.";
        this.QueryBuilderUnrelatedJoinTypeValidation = "Join type 'Unrelated' is invalid.";
        this.QueryBuilderDuplicateFilterNameError = "Filter for {fieldName} can't be added because of a duplicate field names.";
        this.QueryBuilderMissingSchemaError = "Schema {schemaName} is missing in the database for table {tableName} and field {fieldName}.";
        this.QueryBuilderMissingTableError = "Table {tableName} is missing in {schemaName} schema for field {fieldName}.";
        this.QueryBuilderMissingColumnError = "Column {fieldName} is missing in {tableName} table and schema {schemaName}.";
        this.QueryBuilderEmptyFilterFields = "Empty filters. Please select table columns to get started.";
        this.QueryBuilderFilterOperatorEquals = "Equals";
        this.QueryBuilderFilterOperatorLessThanOrEqual = "LessThanOrEqual";
        this.QueryBuilderFilterOperatorGreaterThanOrEqual = "GreaterThanOrEqual";
        this.QueryBuilderFilterOperatorLessThan = "LessThan";
        this.QueryBuilderFilterOperatorGreaterThan = "GreaterThan";
        this.QueryBuilderFilterOperatorNotEquals = "NotEquals";
        this.QueryBuilderFilterOperatorIsNull = "IsNull";
        this.QueryBuilderFilterOperatorIsNotNull = "IsNotNull";
        this.QueryBuilderFilterOperatorLike = "Like";
        this.QueryBuilderAddFilterTooltip = "Add Filter";
        this.QueryBuilderSortingTypeNone = "(none)";
        this.QueryBuilderSortingTypeAscending = "Ascending";
        this.QueryBuilderSortingTypeDescending = "Descending";
        this.QueryBuilderDeleteRelationsWindowTitle = "Delete relations";
        this.QueryBuilderDeleteRelationsMessage = "You've deleted the last field from {tableName} table. Do you want to delete all relationships to it?";
        this.QueryBuilderFieldsGridTableName = "Table name";
        this.QueryBuilderFieldsGridColumnName = "Column name";
        this.QueryBuilderFieldsGridAliasName = "Alias";
        this.QueryBuilderFieldsGridGrouped = "Grouped";
        this.QueryBuilderFieldsGridAggregate = "Aggregate";
        this.QueryBuilderFieldsGridSortingType = "Sorting type";
        this.QueryBuilderFieldsGridSortOrder = "Sort order";
        this.QueryBuilderRelationshipsGridLeftTable = "Left table";
        this.QueryBuilderRelationshipsGridJoinType = "Join type";
        this.QueryBuilderRelationshipsGridRightTable = "Right table";
        this.QueryBuilderRelationshipsGridLeftTableField = "Left table field";
        this.QueryBuilderRelationshipsGridJoinOperator = "Operator";
        this.QueryBuilderRelationshipsGridRightTableField = "Right table field";
        ...
        this.StyleDescription = "Choose a style preset to customize the appearance of the generated report item.";
        ...
        this.DataSourceDescription = "Choose the data source you would like to connect to.";
        this.NoDataSourceTitle = "No Data Source";
        this.DataSourceFieldsTitle = "Data Source Fields";
        this.DataSourceFieldsCategoryGraphDescription = "Add data fields to define the graph. A field in the Categories list defines the categories displayed by the axes. A field in the Series list defines the different series. A field in the Values list defines the aggregated data values.";
        this.DataSourceFieldsTableDescription = "Arrange data source fields to display as table columns.";
        this.ColumnGroupsTitle = "Column Groups";
        this.RowGroupsTitle = "Row Groups";
        this.DetailValuesTitle = "Detail Values";
        this.GroupsDescription = "Arrange data source fields to group data.";
        this.DetailValuesDescription = "Arrange data source fields to display detail values.";
        this.LayoutTitle = "Layout";
        this.LayoutDescription = "Choose whether to show subtotals and grand totals, and their placement.";
        ...
        this.GaugeValueDescription = "The current value of the gauge.";
        this.GaugeRangesCountTitle = "Ranges count";
        this.GaugeRangesCountDescription = "The number of ranges to be generated for the gauge.";
        this.GaugeMinRangeTitle = "Value minimum";
        this.GaugeMinRangeDescription = "The minimum value of the gauge.";
        this.GaugeMaxRangeTitle = "Value maximum";
        this.GaugeMaxRangeDescription = "The maximum value of the gauge.";
        this.GaugeSyncRangesTitle = "Sync ranges";
        this.GaugeSyncRangesDescription = "Determines whether one range will start where the previous ends or their limits will be independent.";
        this.GaugeRangeTitle = "Range";
        this.GaugeMajorTicksSegmentCountTitle = "Major segments count";
        this.GaugeMajorTicksSegmentCountDescription = "The number of major (numbered) tick segments to be generated for the gauge.";
        this.GaugeMinorTicksSegmentCountTitle = "Minor segments count";
        this.GaugeMinorTicksSegmentCountDescription = "The number of minor (not numbered) tick segments to be generated for the gauge.";
        this.GaugeNeedleThicknessTitle = "Needle thickness";
        this.GaugeNeedleThicknessDescription = "The thickness of the needle to be generated for the gauge.";
        this.GaugeScaleStartTitle = "Scale start";
        this.GaugeScaleStartDescription = "The start of the current scale to be generated for the gauge.";
        this.GaugeScaleEndTitle = "Scale end";
        this.GaugeScaleEndDescription = "The end of the current scale to be generated for the gauge.";
        this.GaugeIndicatorThicknessTitle = "Indicator thickness";
        this.GaugeIndicatorThicknessDescription = "The indicator thickness of the gauge.";
        this.GaugeIndicatorTypeTitle = "Indicator type";
        this.GaugeIndicatorTypeDescription = "The indicator type to be generated for the gauge.";
        this.GaugeTypeDescription = "The type of the gauge.";
        ...
        this.EditorToolbarApplyFormat = "Apply format";
        this.EditorToolbarBackColor = "Background color";
        this.EditorToolbarBold = "Bold";
        this.EditorToolbarCopyFormat = "Copy format";
        this.EditorToolbarCleanFormatting = "Clean formatting";
        this.EditorToolbarCreateLink = "Insert hyperlink";
        this.EditorDialogCancel = "Cancel";
        this.EditorDialogInsert = "Insert";
        this.EditorDialogOk = "Ok";
        this.EditorDialogUpdate = "Update";
        this.EditorToolbarFontName = "Select font family";
        this.EditorToolbarFontNameInherit = "(inherited font)";
        this.EditorToolbarFontSize = "Select font size";
        this.EditorToolbarFontSizeInherit = "(inherited size)";
        this.EditorToolbarForeColor = "Color";
        this.EditorToolbarIndent = "Indent";
        this.EditorToolbarInsertHtml = "Insert HTML";
        this.EditorToolbarInsertOrderedList = "Insert ordered list";
        this.EditorToolbarInsertUnorderedList = "Insert unordered list";
        this.EditorToolbarItalic = "Italic";
        this.EditorToolbarJustifyCenter = "Center text";
        this.EditorToolbarJustifyFull = "Justify";
        this.EditorToolbarJustifyLeft = "Align text left";
        this.EditorToolbarJustifyRight = "Align text right";
        this.EditorLinkOpenInNewWindow = "Open link in new window";
        this.EditorLinkText = "Text";
        this.EditorLinkWebAddress = "Web address";
        this.EditorToolbarOutdent = "Outdent";
        this.EditorToolbarRedo = "Redo";
        this.EditorToolbarSubscript = "Subscript";
        this.EditorToolbarSuperscript = "Superscript";
        this.EditorToolbarUnderline = "Underline";
        this.EditorToolbarUndo = "Undo";
        this.EditorToolbarViewHtml = "View HTML";
        this.EditorToolbarInsertNewLine = "New line";
        this.ConfirmationDialogOk = "Ok";
        this.ConfirmationDialogCancel = "Cancel";
        this.ConfirmationDialogYes = "Yes";
        this.ConfirmationDialogNo = "No";
    }
}
